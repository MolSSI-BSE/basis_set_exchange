    ...
    for k, v in bs2["elements"].items():
        ...
        if "ecp_potentials" in v and "ecp_potentials" in bs1_el:
            ...
            if int(nel1) != int(nel2):
                ...
                max_rdiff_ecp = max(max_rdiff_ecp, potentials_difference(v["ecp_potentials"], bs1_el["ecp_potentials"]))
...
def compare_basis_against_file(
    basis_name, src_filepath, file_type=None, version=None, uncontract_general=False, data_dir=None
):
