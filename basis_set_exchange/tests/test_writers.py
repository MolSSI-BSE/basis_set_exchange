...
from .common_testvars import bs_formats, ref_formats, bs_names_sample

my_formats = [x for x in bs_formats if x is not None]
...
def test_write_basis_file(bs_name, bs_fmt, tmp_path, as_bz2):
