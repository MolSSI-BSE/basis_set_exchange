...
def run_bsecurate_cli():
    ...
    subp = subparsers.add_parser(
        "elements-in-files", help="For a list of JSON files, output what elements are in each file"
    )
    ...
    subp.add_argument(
        "-r", "--right", nargs="+", required=True, help="JSON files with data to subtract from the base files"
    )
