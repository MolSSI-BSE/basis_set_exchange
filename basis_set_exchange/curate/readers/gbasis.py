...
def read_gbasis(basis_path):
    '''Reads a gbasis-formatted file and converts it to a dictionary with the
       usual BSE fields
    ...
    if not os.path.isfile(basis_path):
        raise RuntimeError('Gbasis basis set path \'{}\' does not exist'.format(basis_path))
