...
def compare_elements(
    element1, element2, compare_electron_shells_meta=False, compare_ecp_pots_meta=False, compare_meta=False, rel_tol=0.0
):
    """
    ...
    if not _compare_keys(
        element1, element2, "electron_shells", electron_shells_are_equal, compare_electron_shells_meta, rel_tol
    ):
        return False
