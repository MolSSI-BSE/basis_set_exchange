...
def run_bse_cli():
    ...
    subp = subparsers.add_parser(
        "list-formats", help="Output a list of basis set formats that can be used with obtaining a basis set"
    )
    subp.add_argument("-n", "--no-description", action="store_true", help="Print only the format names")

    # list-writer-formats subcommand
    subp = subparsers.add_parser(
        "list-writer-formats", help="Output a list available basis set formats that can be written"
    )
    subp.add_argument("-n", "--no-description", action="store_true", help="Print only the format names")
    ...
    subp.add_argument(
        "-s", "--substr", help="Limit the basis set list to only basis sets whose name contains the specified substring"
    )
    subp.add_argument(
        "-e", "--elements", help="Limit the basis set list to only basis sets that contain all the given elements"
    )
    ...
    subp.add_argument(
        "--elements", help="Which elements of the basis set to output. Default is all defined in the given basis"
    )
    ...
    subp.add_argument(
        "--elements", help="Which elements to output the references for. Default is all defined in the given basis."
    )
    ...
    subp.add_argument(
        "--in-fmt", type=str, default=None, help="Input format (default: autodetected from input filename"
    ).completer = cli_read_fmt_completer
    subp.add_argument(
        "--out-fmt", type=str, default=None, help="Output format (default: autodetected from output filename"
